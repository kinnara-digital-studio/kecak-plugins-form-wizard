                        ...
                        <#list element.children as e>
                            <#if e.className == '${formWizardChildClassName}' >
                                ...
                                <#if cPageNum! == e.properties.pageNum!?number >
                                    ...
                                    <li data-step="${e.properties.pageNum!number}" class="active">
                                        <span class="step">${e.properties.pageNum!number}</span>
                                        <span class="title">${e.properties.label!?html}</span>
                                    </li>
                                <#else>
                                    <li data-step="${e.properties.pageNum!number}">
                                        <span class="step">${e.properties.pageNum!number}</span>
                                        <span class="title">${e.properties.label!?html}</span>
                                    </li>
                                </#if>
